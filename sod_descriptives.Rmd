---
title: "State of Open Data Descriptives"
author: "Laurence Horton"
date: "20/03/2022"
output: html_document
---

```{r, child = "sod_cleaning.Rmd", include = FALSE}
```
...
Q2.6_1 <-
  select(sod, Survey, Q2.6_1) %>%
  count(Q2.6_1) %>%
  filter(Q2.6_1 != "0") %>%
  rename("Q2.6" = "Q2.6_1")

Q2.6_2 <-
  select(sod, Survey, Q2.6_2) %>%
  count(Q2.6_2) %>%
  filter(Q2.6_2 != "0") %>%
  rename("Q2.6" = "Q2.6_2")

Q2.6_3 <-
  select(sod, Survey, Q2.6_3) %>%
  count(Q2.6_3) %>%
  filter(Q2.6_3 != "0") %>%
  rename("Q2.6" = "Q2.6_3")

Q2.6_4 <-
  select(sod, Survey, Q2.6_4) %>%
  count(Q2.6_4) %>%
  filter(Q2.6_4 != "0") %>%
  rename("Q2.6" = "Q2.6_4")

Q2.6_5 <-
  select(sod, Survey, Q2.6_5) %>%
  count(Q2.6_5) %>%
  filter(Q2.6_5!= "0") %>%
  rename("Q2.6" = "Q2.6_5")
...
# Select all that apply
Q3.2_1 <-
  select(sod, Survey, Q3.2_1) %>%
  count(Q3.2_1) %>%
  filter(Q3.2_1 != "0") %>%
  rename("Q3.2" = "Q3.2_1")

Q3.2_2 <-
  select(sod, Survey, Q3.2_2) %>%
  count(Q3.2_2) %>%
  filter(Q3.2_2 != "0") %>%
  rename("Q3.2" = "Q3.2_2")

Q3.2_3 <-
  select(sod, Survey, Q3.2_3) %>%
  count(Q3.2_3) %>%
  filter(Q3.2_3 != "0") %>%
  rename("Q3.2" = "Q3.2_3")

Q3.2_4 <-
  select(sod, Survey, Q3.2_4) %>%
  count(Q3.2_4) %>%
  filter(Q3.2_4 != "0") %>%
  rename("Q3.2" = "Q3.2_4")

Q3.2_5 <-
  select(sod, Survey, Q3.2_5) %>%
  count(Q3.2_5) %>%
  filter(Q3.2_5 != "0") %>%
  rename("Q3.2" = "Q3.2_5")
...
# Select all that apply
Q3.4_1 <-
  select(sod, Survey, Q3.4_1) %>%
  count(Q3.4_1) %>%
  filter(Q3.4_1 != "0") %>%
  rename("Q3.4" = "Q3.4_1")

Q3.4_2 <-
  select(sod, Survey, Q3.4_2) %>%
  count(Q3.4_2) %>%
  filter(Q3.4_2 != "0") %>%
  rename("Q3.4" = "Q3.4_2")

Q3.4_3 <-
  select(sod, Survey, Q3.4_3) %>%
  count(Q3.4_3) %>%
  filter(Q3.4_3 != "0") %>%
  rename("Q3.4" = "Q3.4_3")

Q3.4_4 <-
  select(sod, Survey, Q3.4_4) %>%
  count(Q3.4_4) %>%
  filter(Q3.4_4 != "0") %>%
  rename("Q3.4" = "Q3.4_4")

Q3.4_5 <-
  select(sod, Survey, Q3.4_5) %>%
  count(Q3.4_5) %>%
  filter(Q3.4_5 != "0") %>%
  rename("Q3.4" = "Q3.4_5")
...
# Select all that apply
Q3.8_1 <-
  select(sod, Survey, Q3.8_1) %>%
  count(Q3.8_1) %>%
  filter(Q3.8_1 != "0") %>%
  rename("Q3.8" = "Q3.8_1")

Q3.8_2 <-
  select(sod, Survey, Q3.8_2) %>%
  count(Q3.8_2) %>%
  filter(Q3.8_2 != "0") %>%
  rename("Q3.8" = "Q3.8_2")

Q3.8_3 <-
  select(sod, Survey, Q3.8_3) %>%
  count(Q3.8_3) %>%
  filter(Q3.8_3 != "0") %>%
  rename("Q3.8" = "Q3.8_3")

Q3.8_4 <-
  select(sod, Survey, Q3.8_4) %>%
  count(Q3.8_4) %>%
  filter(Q3.8_4 != "0") %>%
  rename("Q3.8" = "Q3.8_4")

Q3.8_5 <-
  select(sod, Survey, Q3.8_5) %>%
  count(Q3.8_5) %>%
  filter(Q3.8_5 != "0") %>%
  rename("Q3.8" = "Q3.8_5")

Q3.8_6 <-
  select(sod, Survey, Q3.8_6) %>%
  count(Q3.8_6) %>%
  filter(Q3.8_6 != "0") %>%
  rename("Q3.8" = "Q3.8_6")
...
```{r Q3.13}
Q3.13_1 <-
  select(sod, Survey, Q3.13_1) %>%
  count(Q3.13_1) %>%
  filter(Q3.13_1 != "0") %>%
  rename("Q3.13" = "Q3.13_1")

Q3.13_2 <-
  select(sod, Survey, Q3.13_2) %>%
  count(Q3.13_2) %>%
  filter(Q3.13_2 != "0") %>%
  rename("Q3.13" = "Q3.13_2")

Q3.13_3 <-
  select(sod, Survey, Q3.13_3) %>%
  count(Q3.13_3) %>%
  filter(Q3.13_3 != "0") %>%
  rename("Q3.13" = "Q3.13_3")

Q3.13_4 <-
  select(sod, Survey, Q3.13_4) %>%
  count(Q3.13_4) %>%
  filter(Q3.13_4 != "0") %>%
  rename("Q3.13" = "Q3.13_4")

Q3.13_5 <-
  select(sod, Survey, Q3.13_5) %>%
  count(Q3.13_5) %>%
  filter(Q3.13_5 != "0") %>%
...
```{r Q4.4}
Q4.4_1 <-
  select(sod, Survey, Q4.4_1) %>%
  count(Q4.4_1) %>%
  filter(Q4.4_1 != "0") %>%
  rename("Q4.4" = "Q4.4_1")

Q4.4_2 <-
  select(sod, Survey, Q4.4_2) %>%
  count(Q4.4_2) %>%
  filter(Q4.4_2 != "0") %>%
  rename("Q4.4" = "Q4.4_2")

Q4.4_3 <-
  select(sod, Survey, Q4.4_3) %>%
  count(Q4.4_3) %>%
  filter(Q4.4_3 != "0") %>%
  rename("Q4.4" = "Q4.4_3")

Q4.4_4 <-
  select(sod, Survey, Q4.4_4) %>%
  count(Q4.4_4) %>%
  filter(Q4.4_4 != "0") %>%
  rename("Q4.4" = "Q4.4_4")

Q4.4_5 <-
  select(sod, Survey, Q4.4_5) %>%
  count(Q4.4_5) %>%
  filter(Q4.4_5 != "0") %>%
  rename("Q4.4" = "Q4.4_5")

Q4.4_6 <-
  select(sod, Survey, Q4.4_6) %>%
  count(Q4.4_6) %>%
  filter(Q4.4_6 != "0") %>%
  rename("Q4.4" = "Q4.4_6")
...
```{r Q4.5}
Q4.5_1 <-
  select(sod, Survey, Q4.5_1) %>%
  count(Q4.5_1) %>%
  filter(Q4.5_1 != "0") %>%
  rename("Q4.5" = "Q4.5_1")

Q4.5_2 <-
  select(sod, Survey, Q4.5_2) %>%
  count(Q4.5_2) %>%
  filter(Q4.5_2 != "0") %>%
  rename("Q4.5" = "Q4.5_2")

Q4.5_3 <-
  select(sod, Survey, Q4.5_3) %>%
  count(Q4.5_3) %>%
  filter(Q4.5_3 != "0") %>%
  rename("Q4.5" = "Q4.5_3")

Q4.5_4 <-
  select(sod, Survey, Q4.5_4) %>%
  count(Q4.5_4) %>%
  filter(Q4.5_4 != "0") %>%
  rename("Q4.5" = "Q4.5_4")

Q4.5_5 <-
  select(sod, Survey, Q4.5_5) %>%
  count(Q4.5_5) %>%
  filter(Q4.5_5 != "0") %>%
  rename("Q4.5" = "Q4.5_5")

Q4.5_6 <-
  select(sod, Survey, Q4.5_6) %>%
  count(Q4.5_6) %>%
  filter(Q4.5_6 != "0") %>%
  rename("Q4.5" = "Q4.5_6")
...
```{r Q4.10}
Q4.10_1 <-
  select(sod, Survey, Q4.10_1) %>%
  count(Q4.10_1) %>%
  filter(Q4.10_1 != "0") %>%
  rename("Q4.10" = "Q4.10_1")

Q4.10_2 <-
  select(sod, Survey, Q4.10_2) %>%
  count(Q4.10_2) %>%
  filter(Q4.10_2 != "0") %>%
  rename("Q4.10" = "Q4.10_2")

Q4.10_3 <-
  select(sod, Survey, Q4.10_3) %>%
  count(Q4.10_3) %>%
  filter(Q4.10_3 != "0") %>%
  rename("Q4.10" = "Q4.10_3")

Q4.10_4 <-
  select(sod, Survey, Q4.10_4) %>%
  count(Q4.10_4) %>%
  filter(Q4.10_4 != "0") %>%
  rename("Q4.10" = "Q4.10_4")

Q4.10_5 <-
  select(sod, Survey, Q4.10_5) %>%
  count(Q4.10_5) %>%
  filter(Q4.10_5 != "0") %>%
  rename("Q4.10" = "Q4.10_5")

Q4.10_6 <-
  select(sod, Survey, Q4.10_6) %>%
  count(Q4.10_6) %>%
  filter(Q4.10_6 != "0") %>%
  rename("Q4.10" = "Q4.10_6")

Q4.10_7 <-
  select(sod, Survey, Q4.10_7) %>%
  count(Q4.10_7) %>%
  filter(Q4.10_7 != "0") %>%
  rename("Q4.10" = "Q4.10_7")

Q4.10_8 <-
  select(sod, Survey, Q4.10_8) %>%
  count(Q4.10_8) %>%
  filter(Q4.10_8 != "0") %>%
...
```{r Q4.12}
Q4.12_1 <-
  select(sod, Survey, Q4.12_1) %>%
  count(Q4.12_1) %>%
  filter(Q4.12_1 != "0") %>%
  rename("Q4.12" = "Q4.12_1")

Q4.12_2 <-
  select(sod, Survey, Q4.12_2) %>%
  count(Q4.12_2) %>%
  filter(Q4.12_2 != "0") %>%
  rename("Q4.12" = "Q4.12_2")

Q4.12_3 <-
  select(sod, Survey, Q4.12_3) %>%
  count(Q4.12_3) %>%
  filter(Q4.12_3 != "0") %>%
  rename("Q4.12" = "Q4.12_3")

Q4.12_4 <-
  select(sod, Survey, Q4.12_4) %>%
  count(Q4.12_4) %>%
  filter(Q4.12_4 != "0") %>%
  rename("Q4.12" = "Q4.12_4")

Q4.12_5 <-
  select(sod, Survey, Q4.12_5) %>%
  count(Q4.12_5) %>%
  filter(Q4.12_5 != "0") %>%
  rename("Q4.12" = "Q4.12_5")

Q4.12_6 <-
  select(sod, Survey, Q4.12_6) %>%
  count(Q4.12_6) %>%
  filter(Q4.12_6 != "0") %>%
